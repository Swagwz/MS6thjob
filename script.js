...
btn.addEventListener("click", function () {
  ...
  const masteryProgress =
    calcErdaFragNum(masteryCore.slice(0, mastery)) / maxMastery;

  // 強化核心進度
  const enhancement1Progress =
    calcErdaFragNum(enhancementCore.slice(0, enhancement1)) / maxEnhancement;
  const enhancement2Progress =
    calcErdaFragNum(enhancementCore.slice(0, enhancement2)) / maxEnhancement;
  const enhancement3Progress =
    calcErdaFragNum(enhancementCore.slice(0, enhancement3)) / maxEnhancement;
  const enhancement4Progress =
    calcErdaFragNum(enhancementCore.slice(0, enhancement4)) / maxEnhancement;

  // 六轉總進度
  const totalProgress =
    (skillProgress * maxSkill +
      masteryProgress * maxMastery +
